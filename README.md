# 数学公式识别与LaTeX转换工具（基于YOLOv11+Pix2tex）
一个能对复杂环境下的数学公式进行识别并转换为Latesx代码的工具（比赛项目，模型精度尚有提高空间，数据来源于2025讯飞开发者大赛）。  
A tool capable of recognizing and converting mathematical formulas in complex environments into LaTeX code (competition project, model accuracy has room for improvement, Data source: 2025 iFlytek Developer Competition)).
...
### 处理后图片展示： 
<div align="center"><img width="2052" height="622" alt="image" src="https://github.com/user-attachments/assets/4cb7fd60-75fa-4133-b6ac-96b7ac705b7c" /></div>     
